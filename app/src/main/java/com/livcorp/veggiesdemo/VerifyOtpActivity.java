...
import com.livcorp.veggiesdemo.databinding.ActivityVerifyOtpBinding;
...
public class VerifyOtpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String phoneNo = "+91"+getIntent().getStringExtra("phone");
                                ...
                                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            binding.progressBarVerify.setVisibility(View.VISIBLE);
                                            binding.btnVerify.setVisibility(View.INVISIBLE);
                                            UserModel model = new UserModel("empty","","","","",phoneNo);
