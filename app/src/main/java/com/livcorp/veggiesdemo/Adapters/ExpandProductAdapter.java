...
public class ExpandProductAdapter extends RecyclerView.Adapter<ExpandProductAdapter.viewHolder> {
    ...
    public ExpandProductAdapter(ArrayList<ProductModel> list,ArrayList<CartModel> cart, Context context, TextView tvCartSize){
        this.list = list;
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.sample_expand_recyclerview_layout,parent,false);
